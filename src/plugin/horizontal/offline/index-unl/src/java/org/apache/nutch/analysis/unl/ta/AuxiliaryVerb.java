...
public class AuxiliaryVerb {
    ...
    public static boolean check1(Stack s) {
        //System.out.println("Auxillary verb check1");
        if (!ADictionary.verb(s)) {
            if (AuxiliaryVerb.infinitive_VP(s)) {
                //System.out.println("Auxillary verb check1 infinite_vp");
                if (ADictionary.verb(s)) {
                    //System.out.println("Auxillary verb check1 if");
                    return true;
                } else if (VerbalParticiple.check(s)) {
                    //System.out.println("Auxillary verb check1 else if");
                    hasAux = true;
                    check1(s);
                    return true;
                } else if (Infinity.check(s)) {
                    //System.out.println("Auxillary verb check1 else if infinity");
                    hasAux = true;
                    check1(s);
                    return true;
                }
            ...
            if (AuxiliaryVerb.verbalParticiple(s)) {
                //System.out.println("Auxillary verb check1 verbal");
                if (VerbalParticiple.check(s)) {
                    //System.out.println("Auxillary verb check1 verbal check");
                    hasAux = true;
                    check1(s);
                    return true;
                }
            ...
            if (AuxiliaryVerb.infinitive(s)) {
                //System.out.println("Auxillary verb check1 auxillary");
                if (Infinity.check(s)) {
                    //System.out.println("Auxillary verb check1 aux inf");
                    hasAux = true;
                    check1(s);
                    return true;
                }
        ...
        if (hasAux) {
            //System.out.println("Auxillary verb check1 last");
