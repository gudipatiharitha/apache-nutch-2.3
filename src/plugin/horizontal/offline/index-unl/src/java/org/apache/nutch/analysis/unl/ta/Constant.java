...
`	 DOUBLING_LETTER
    ...
    static byte[] iyaR={3,24,1,30};//இயற் //to handle the word இயற்கையில் which is end with kaiyil. If not work then see in postposition.check program
    static byte[] kang={14,1,15};//கங்
	...
	// POSTPOSITION
        static byte kUdiya[]={14,6,18,3,24,1};// கூடிய
