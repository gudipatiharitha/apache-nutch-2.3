...
public class Verb {
    ...
    public static boolean check(Stack allStk, byte[] topElmt, boolean analysePart) {
        ...
        while (flag < 2) {
            ...
            if (Postposition.check_Verb(s)) {
                ////System.out.println("Enter into postpostion");
            ...
            if (ADictionary.verb(s)) {
                allStk.push(s);
                return true;
            }  if(ADictionary.Nverb(s)){ //To handle the word உருமாற்றுகிறது, include this coding... 23-5-12
                ////System.out.println("Ebntering ino NVERb");
                allStk.push(s);
                return true;
            }
            ...
            if (PNG.check(s)) {
                ////System.out.println("png cvheckinig");
                nopng = false;
                ...
                //clia.unl.unicode.utils.Utils.printStack(Analyser.print, s, "check forTense");
                if (Tense.check(s)) {
                    ////System.out.println("tense check in vertn");
                    gotoVerbExp = true;
                    if (ADictionary.verb(s)) {
                        ////System.out.println("tense check in vertn 1");
                        allStk.push(s);
                        return true;
                    }
                }
                //clia.unl.unicode.utils.Utils.printStack(Analyser.print, s, "before noun");
                ////System.out.println("14 missing");
                if (AuxiliaryVerb.check(s)) {
                    ////System.out.println("AuxiliaryVerb check in vertn ");
                    if (ADictionary.m_EndNoun(s)) {
                        ////System.out.println("AuxiliaryVerb check in vertn 1");
                        allStk.push(s);
                        return true;
                    }
                    if (ADictionary.verb(s)) {
                        ////System.out.println("AuxiliaryVerb check in vertn 2");
                        allStk.push(s);
                        return true;
                    }
   
                } else if (Infinity.mAtt(s)) {
                    ////System.out.println("AuxiliaryVerb check in vertn else");
                    if (Infinity.check(s)) {
                        if (ADictionary.verb(s)) {
                            allStk.push(s);
                            return true;
            ...
            if (VerbMisc.finiteVerb(s)) {
                ////System.out.println("in verb.java");
                originalStack = (Stack) s.clone();
            ...
            if (VerbMisc.umpadi(s)) {
                ////System.out.println("in verb.java umpadi");
                if (ADictionary.verb(s)) {
                    allStk.push(s);
                    return true;
                }
            ...
            if (Infinity.infinitive_Ends(s)) {
                ////System.out.println("in verb.java infinity ends");
                if (ADictionary.verb(s)) {
                    allStk.push(s);
                    return true;
                }
            ...
            //For verbal noun rule
            ////System.out.println("25 VN");
            if (RelativeParticiple.check_verbal_noun(s)) {
                // if (Tense.check(s)) {
                //if(Sandhi.kctp(s))){
                //clia.unl.unicode.utils.Utils.printStack(Analyser.print, s, "temp ...............check");
                Sandhi.kctp(s);
...
// "al"
           ...
           /* if (ADictionary.noun(s)) {
            ...
            flag++;
        } //while condition of flag is closed
