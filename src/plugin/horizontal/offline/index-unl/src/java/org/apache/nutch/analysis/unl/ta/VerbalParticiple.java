...
public class VerbalParticiple {
    ...
    public static boolean check(Stack s) {
        ...
        /*
         * // i if (ByteMeth.endsWith(topElmt, Constant.i)) {
         * //clia.unl.unicode.utils.Utils.printOut(Analyser.print, x + "i");
         * s.pop(); s.push(new Entry(Constant.i, Tag.PastTenseMarker)); topElmt
         * = ByteMeth.subArray(topElmt, 0, topElmt.length - Constant.i.length);
         * s.push(new Entry(topElmt, -1, oldTopElmt)); Sandhi.type4(s);
         * Sandhi.type5(s); return true;
		}
         */

        // n_thu
        if (ByteMeth.endsWith(topElmt, Constant.n_thu)) {
            // System.out.println("nthu of verbal participle");
            ...
            if (ByteMeth.contains(topElmt, Constant.va)
               ...
               // System.out.println("nthu of verbal participle in if " + UnicodeConverter.revert(topElmt));
            }
