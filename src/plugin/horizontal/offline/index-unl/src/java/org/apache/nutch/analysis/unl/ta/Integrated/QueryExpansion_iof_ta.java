...
public class QueryExpansion_iof_ta implements Serializable {
    ...
    /*
     * public Configuration conf; public String setConf(Configuration
     * conf,String property) { this.conf = conf; unlResourceDir =
     * conf.get(property); return unlResourceDir; } public Configuration
